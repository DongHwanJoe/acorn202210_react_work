...
//여기서 import한 cn은 function으로 생각하고 사용
import cn from "classnames";
import binder from "classnames/bind";
//classname binder를 이용해서 모듈화된 css를 바인딩해서 참조값을 cs에 대입
    ...
    render() {
        return (
            <div className="container">
                ...
                {/* cn({}) object를 전달해서 true, false 를 활용해 클래스 적용여부 결정 */}
